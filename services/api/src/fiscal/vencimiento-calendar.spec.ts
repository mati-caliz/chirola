import { upcomingVencimientos, FiscalObligation, VencimientoStatus } from "./vencimiento-calendar";
...
describe("upcomingVencimientos", () => {
  ...
  it("marca OVERDUE / DUE_SOON / UPCOMING según la fecha de hoy", () => {
    ...
    const cargas = result.find((item) => item.type === FiscalObligation.CARGAS_SOCIALES);
