...
describe("WsfexService — armado del comprobante de exportación", () => {
  const build = (request: ExportCaeRequest): string => service().buildRequest(request);
...
describe("WsfexService — respuesta de FEXAuthorize", () => {
  ...
  const authorized =
    "<Resultado>A</Resultado><Cae>68000000000001</Cae>" + "<Fch_venc_Cae>20260722</Fch_venc_Cae>";
