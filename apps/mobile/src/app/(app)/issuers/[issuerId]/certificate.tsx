        ...
        {step === 0 ? (
          <>
            <View style={{ alignItems: "center", gap: 10, paddingVertical: 12 }}>
              ...
              >
                Para facturar a tu nombre, ARCA pide un certificado digital. Se hace una sola vez y tarda unos
                5 minutos. Te guiamos en cada paso.
              </Text>
            </View>
            <Card>
              <Text
              ...
              >
                Queda cifrada en el servidor y nunca sale de ahí. Con ella armamos el «pedido de certificado»
                (CSR) que ARCA necesita.
              </Text>
            </Card>
          </>
        ) : null}
