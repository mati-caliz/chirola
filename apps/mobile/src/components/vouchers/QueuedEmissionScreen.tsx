      ...
      <View style={{ flex: 1, alignItems: "center", justifyContent: "center", gap: 14, padding: 32 }}>
        <View
          style={{
            ...
            height: 88,
            borderRadius: 44,
            backgroundColor: theme.colors.statusPendienteBg,
            alignItems: "center",
        ...
        >
          ARCA no respondió a tiempo. No hace falta que lo vuelvas a emitir: lo reintentamos solos y te
          avisamos cuando tenga CAE.
        </Text>
