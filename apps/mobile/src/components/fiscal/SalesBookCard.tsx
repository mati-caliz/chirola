    ...
    <Card>
      ...
      {book.isLoading ? (
        ...
        <>
          ...
          <SalesRow label="Exento y no gravado" value={formatCurrency(totals.exemptAmount + totals.untaxedAmount)} />
          <SalesRow label="IVA débito" value={formatCurrency(totals.ivaAmount)} />
        </>
      ) : (
        <Text style={{ marginVertical: 12, fontFamily: theme.font.regular, fontSize: theme.fontSize.callout, color: theme.colors.textSecondary }}>
